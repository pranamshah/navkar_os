      ...
      >
        <div className="px-4 py-3 border-b border-white/10">
          ...
          <div className="flex items-center gap-1.5 mt-2">
            <span className="material-symbols-outlined text-[#7C3AED]" style={{ fontSize: 14, fontVariationSettings: "'FILL' 1" }}>
              directions_truck
            </span>
            <span className="text-white/60 text-xs font-semibold tracking-wide">RunDesk</span>
          </div>
        </div>
                  ...
                  >
                    {section.items.map((item) => (
                      <Link
                        ...
                        style={{
                          background: isActive(item.href) ? "#7C3AED" : "transparent",
